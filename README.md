...
```bash
wget -O - https://raw.githubusercontent.com/Bradford1040/klipper_tmc_autotune/master/install.sh | bash
```
...
origin: https://github.com/Bradford1040/klipper_tmc_autotune.git
